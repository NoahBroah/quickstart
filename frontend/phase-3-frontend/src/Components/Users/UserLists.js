      ...
      {singleUser ? (
        <Card style={{ width: "18rem" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              This user makes an hourly rate of ${hourly_rate}. Using this information we can view their transactions and see how much of their time is spent on different categories. 
            </Card.Text>
